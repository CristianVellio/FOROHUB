...
import com.cristianvellio.FOROHUB.domain.usuario.dto.DetallesUsuarioDTO;
import com.cristianvellio.FOROHUB.domain.usuario.repository.UsuarioRepository;
import com.cristianvellio.FOROHUB.domain.usuario.validations.create.ValidarCrearUsuario;
import com.cristianvellio.FOROHUB.domain.usuario.validations.update.ValidarActualizarUsuario;
...
public class UsuarioController {
    ...
    public ResponseEntity<DetallesUsuarioDTO> crearUsuario(@RequestBody @Valid CrearUsuarioDTO crearUsuarioDTO,
        ...
        if (crearUsuarioDTO.password() == null || crearUsuarioDTO.password().isEmpty()) {
    ...
    public ResponseEntity<Page<DetallesUsuarioDTO>> leerTodosUsuarios(
    ...
    public ResponseEntity<Page<DetallesUsuarioDTO>> leerUsuariosActivos(
            @PageableDefault(size = 5, sort = { "id" }) Pageable pageable) {
    ...
    public ResponseEntity<DetallesUsuarioDTO> actualizarUsuario(
            @RequestBody @Valid ActualizarUsuarioDTO actualizarUsuarioDTO, @PathVariable String username) {
