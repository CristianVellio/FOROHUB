...
import com.cristianvellio.FOROHUB.domain.curso.dto.DetalleCursoDTO;
...
public class CursoController {
    ...
    public ResponseEntity<Page<DetalleCursoDTO>> listarCursos(
    ...
    public ResponseEntity<Page<DetalleCursoDTO>> listarCursosActivos(
            @PageableDefault(size = 5, sort = { "id" }) Pageable pageable) {
