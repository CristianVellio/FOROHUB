...
import com.cristianvellio.FOROHUB.domain.respuesta.validations.create.ValidarRespuestaCreada;
import com.cristianvellio.FOROHUB.domain.respuesta.validations.update.ValidarRespuestaActualizada;
...
public class RespuestaController {
    ...
    public ResponseEntity<Page<DetalleRespuestaDTO>> leerRespuestaDeTopico(
            @PageableDefault(size = 5, sort = {
                    "ultimaActualizacion" }, direction = Sort.Direction.ASC) Pageable pageable,
    ...
    public ResponseEntity<DetalleRespuestaDTO> actualizarRespuesta(
            @RequestBody @Valid ActualizarRespuestaDTO actualizarRespuestaDTO, @PathVariable Long id) {
